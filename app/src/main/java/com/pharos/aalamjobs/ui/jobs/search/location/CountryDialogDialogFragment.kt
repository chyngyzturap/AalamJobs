...
import com.pharos.aalamjobs.data.responses.dialog.CountryResponseItem
...
class CountryDialogDialogFragment(private val listener: SearchListener):BaseDialogFragment<JobsViewModel, LayoutCountryBinding, JobsRepository>(),
    CountryListener,
