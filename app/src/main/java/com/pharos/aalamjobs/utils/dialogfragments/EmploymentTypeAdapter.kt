...
import com.pharos.aalamjobs.data.responses.dialog.EmploymentTypeResponseItem
...
class EmploymentTypeAdapter(
    ...
    companion object {
        private val DIFF = object : DiffUtil.ItemCallback<EmploymentTypeResponseItem>() {
            override fun areItemsTheSame(oldItem: EmploymentTypeResponseItem, newItem: EmploymentTypeResponseItem): Boolean {
                return oldItem.id == newItem.id
            }

            override fun areContentsTheSame(oldItem: EmploymentTypeResponseItem, newItem: EmploymentTypeResponseItem): Boolean {
                return oldItem.id == newItem.id
            }
